...
//GameData, Item 클래스를 담고 있는 네임스페이스 명시
using DataInfo;
...
public class GameManager : MonoBehaviour {
    ...
    //DataManager에서 로드할 데이터를 저장할 변수
    //[HideInInspector] public GameDataObject gameData;
    //DataManager를 저장할 변수
    private DataManager dataManager;

    //public GameData gameData;  //삭제하거나 주석으로 처리 한다.
    ...
    public void AddItem(Item item)
    {
        ...
        //아이템이 변경된 것을 실시간으로 반영하기 위해 이벤트 발생시킴
        OnItemChange();
    }
